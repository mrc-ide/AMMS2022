---
title: "Pratique AMMS : Introduction à la puissance statistique" 
author: "Bob Verity"
...
**A1.** Moyennes et variances indiquées ci-dessous. La moyenne est légèrement supérieure dans le groupe témoin.
...
**A7.** La valeur se trouve dans le corps de la distribution. Cela signifie que nous sommes assez susceptibles de voir une valeur aussi extrême que celle-ci si l'hypothèse nulle est vraie.
...
**A9.** La valeur p est d'environ 0,37, ce qui est supérieur à 0,05, donc non significatif au niveau de 5 %. Sur la base de cette valeur, nous ne pouvons pas rejeter l'hypothèse nulle selon laquelle il n'y a pas de différence entre le COI dans les populations de contrôle et de moustiquaires.
