...
**Q111:** Using the `tidyverse`, convert "0/0" to 0, "0/1" to 0.5, "1/1" to 1. Hint: the command to explore is `dplyr::case_when()`.
...
where $n_alt$ and $n_ref$ are the number of alternative and number of reference alleles observed across the entire population, respectively. 
...
**Q112:** Calculate the mean PLAF for the DRC and VN.
